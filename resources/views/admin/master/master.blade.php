...
<div class="dash">
    <aside class="dash_sidebar">
        <article class="dash_sidebar_user">
            <img class="dash_sidebar_user_thumb" src="{{ url(asset('backend/assets/images/avatar.jpg')) }}" alt="Avatar" title=""/>
        ...
        <ul class="dash_sidebar_nav">
            ...
            <li class="dash_sidebar_nav_item {{ isActive('admin.products') }}"><a class="icon-cubes" href="{{ route('admin.products.index') }}">Produtos</a>
                <ul class="dash_sidebar_nav_submenu">
            ...
            <li class="dash_sidebar_nav_item {{ isActive('admin.requests') }}"><a class="icon-file-text" href="{{ route('admin.requests.index') }}">Pedidos</a>
                <ul class="dash_sidebar_nav_submenu">
        ...
        <div class="dash_userbar">
            <div class="dash_userbar_box">
                <div class="dash_userbar_box_content">
                    ...
                    <h1 class="transition">
                        <i class="icon-code text-orange"></i><a href="">Sandro<b>Developer</b></a>
                    </h1>
